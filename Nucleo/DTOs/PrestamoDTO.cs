...
namespace Nucleo.DTOs
{
    ...
    {   ///<summary>
        ...
        /// </summary>
        public PrestamoDTO(string pNombreUsuario, int PIdEjemplar,string fechaPrestamo,string fechaLimite,string fechaDevolucion, string estadoPrestamo,string estadoDevolucion)
        {
